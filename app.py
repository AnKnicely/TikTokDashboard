...
if page == "Homepage":
    ...
    filtered_df = df[df['playCount'] < 100000000]
    ...
    #Visuals
        filtered_df2 = filtered_df[filtered_df['playCount'] < 50000000]
        filtered_df2 = filtered_df[filtered_df['playCount'] > 500000]
    ...
    r_col.html("<p><ul>Created by: <li> Ashley Knicely</li></ul><ul>Start Date: <li> 11/01/24</li></ul> <ul>End Date: <li> 12/10/24 </li></ul></p>")
